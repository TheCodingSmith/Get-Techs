...
<table width="600" cellpadding="3" style="border: 1px solid gray;border-collapse:collapse;">
  <tr>
    <th colspan="2" align="center" style="border: 1px solid gray;border-collapse:collapse;">Contact Form - Coding Smith.com</th>
  <tr>
  <tr>
  ...
  <tr>
  <tr>
    <td style="border: 1px solid gray;border-collapse:collapse;" align="right">Service:</td>
    <td style="border: 1px solid gray;border-collapse:collapse;">{service}</td>
  <tr>
  <tr>
